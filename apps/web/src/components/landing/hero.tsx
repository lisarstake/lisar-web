...
const Hero = () => {
  ...
  return (
    <section className="w-full overflow-hidden bg-white min-h-[unset] md:min-h-[90vh] flex items-center">
      <div className="mx-auto w-full max-w-7xl px-6 pt-14 md:px-10 md:pt-14">
        <div className="grid items-center gap-8 md:grid-cols-[1.3fr_1fr] md:gap-10">
          <div>
            <RevealOnScroll>
              <h1 className="text-[#111111] text-[2.7rem] leading-[0.98] tracking-[-0.03em] md:text-[4.5rem]">
                <span className="font-sans font-bold">The better way to</span>
                <br />
                <span className="font-sans italic font-bold text-[#235538]">save and invest.</span>
              </h1>
            </RevealOnScroll>

            <RevealOnScroll delay={0.08}>
              <p className="mt-6 max-w-xl text-base text-[#5f6762] md:text-[1.1rem]">
                Lisar helps millions of customers achieve their financial goals by helping them save and invest with ease. <span className="hidden md:inline">Deposit with fiat, earn dollar-backed yield daily on your savings.</span>
              </p>
            </RevealOnScroll>
          ...
          <RevealOnScroll delay={0.12}>
            <img src="/hero.svg" className="rounded-xl w-full max-w-[450px] md:w-[450px]" />
          </RevealOnScroll>
        </div>
      </div>
    </section>
