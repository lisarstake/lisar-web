...
const faqs: FaqItem[] = [
  {
    ...
    answer:
      "Yes but your experience is seamless; you deposit in local currency, earn in dollars and withdraw in local currency. LISAR uses stablecoin infrastructure in the backend, but you never interact with wallets, seed phrases, or gas fees.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. There are no mandatory lockups. You can withdraw your money back to fiat whenever you choose, subject only to normal network processing times.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "LISAR Savings is the more conservative option — your funds earn yield through stable dollar-backed assets with lower volatility. LISAR Growth generates higher returns through more active yield strategies but carries more variability.",
  },
];
        ...
        <RevealOnScroll>
          <div className="text-center flex flex-col items-center mx-auto max-w-3xl">
            ...
            <h2 className="mt-5 text-[3rem] leading-[0.95] tracking-[-0.03em] text-[#111111] md:text-[4rem]">
              <span className="block font-sans font-semibold">We&apos;ll tell you</span>
              <span className="block font-sans italic text-[#2f6a43]">everything.</span>
            </h2>
            <p className="mt-4 text-base leading-relaxed text-[#5e6660] md:text-lg">
              Because you should only trust products that tells you how it works.
            </p>
          </div>
        </RevealOnScroll>
            ...
            return (
              <RevealOnScroll key={item.question} delay={index * 0.04}>
                <div className="border-b border-[#e1e7e2] py-4">
                  ...
                  {isOpen ? (
                    <p className="mt-3 pr-12 text-sm leading-relaxed text-[#6a736d] md:text-base">
                      {item.answer}
                    </p>
                  ) : null}
                </div>
