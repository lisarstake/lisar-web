      ...
      <div className="flex-1 overflow-y-auto px-6 pb-24 space-y-4 scrollbar-hide mt-3">
        ...
        <div>
          ...
          <input
            value={email}
            readOnly
            className="w-full rounded-lg bg-[#13170a] px-4 py-3 text-base text-white/70 outline-none"
            placeholder="Email"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg bg-[#13170a] px-4 py-3 text-base text-white outline-none"
        ...
        <div>
          ...
          <Select value={country} onValueChange={setCountry}>
            ...
            <SelectContent className="bg-[#13170a] text-white border-none max-h-80">
              {COUNTRIES.map((c) => (
                <SelectItem
                  key={c.code}
                  value={c.name}
