    ...
    <div className="h-screen bg-[#050505] text-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-24 space-y-4 scrollbar-hide">
        <div>
          ...
          {showReadOnly ? (
            <div className="w-full rounded-lg bg-[#13170a] px-4 py-3 text-base text-white/90">
              {accountNumber}
            </div>
          ) : (
            <input
              ...
              className="w-full rounded-lg bg-[#13170a] px-4 py-3 text-base text-white/90 outline-none"
        ...
        <div>
          ...
          <div className="w-full rounded-lg bg-[#13170a] px-4 py-3 text-base text-white/90 min-h-12 flex items-center">
            {lookupLoading ? (
