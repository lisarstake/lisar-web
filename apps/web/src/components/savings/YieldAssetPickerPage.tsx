...
export const YieldAssetPickerPage: React.FC = () => {
  ...
  return (
    <div className="min-h-full bg-[#050505] text-white flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overscroll-contain px-6 pb-20 scrollbar-hide space-y-3">
        <div className="rounded-xl bg-[#151515] px-4">
          <YieldAssetRow
            title="USDC"
