...
export const TransactionsTable: React.FC<TransactionsTableProps> = ({
  ...
  if (transactions.length === 0) {
    return (
      <div className="bg-[#1a1a1a] rounded-xl border border-[#505050] p-8 text-center text-gray-400">
  ...
  return (
    <div className="bg-[#1a1a1a] rounded-xl border border-[#505050] overflow-hidden">
      {/* Table Header */}
      <div className="bg-[#505050] px-6 py-4">
      ...
      <div className="divide-y divide-[#505050]">
        {transactions.map((transaction, index) => (
          <div
            ...
            className="px-6 py-4 hover:bg-[#505050]/50 transition-colors"
          >
      ...
      <div className="bg-[#505050] px-6 py-4">
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-5 md:col-span-3">
            <div className="h-4 bg-[#505050] rounded animate-pulse w-20"></div>
          </div>
          <div className="col-span-3 md:col-span-2">
            <div className="h-4 bg-[#505050] rounded animate-pulse w-16"></div>
          </div>
          <div className="hidden md:block col-span-3">
            <div className="h-4 bg-[#505050] rounded animate-pulse w-24"></div>
          </div>
        ...
        {Array.from({ length: 8 }).map((_, index) => (
          <div key={`skeleton-${index}`} className="px-6 py-4">
            <div className="grid grid-cols-12 gap-4 items-center">
              {/* Account Skeleton */}
              <div className="col-span-5 md:col-span-3">
                <div className="h-6 bg-[#505050] rounded-full animate-pulse w-24"></div>
              </div>
              {/* Event Skeleton */}
              <div className="col-span-3 md:col-span-2">
                <div className="h-4 bg-[#505050] rounded animate-pulse w-20"></div>
              ...
              <div className="hidden md:block col-span-3">
                <div className="h-4 bg-[#505050] rounded animate-pulse w-32"></div>
              </div>
              {/* Date Skeleton */}
              <div className="col-span-4 md:col-span-2">
                <div className="h-4 bg-[#505050] rounded animate-pulse w-24"></div>
              ...
              <div className="hidden md:flex col-span-2 items-center">
                <div className="h-6 bg-[#505050] rounded-full animate-pulse w-20"></div>
              </div>
            </div>
          </div>
        ))}
...
export const TransactionsErrorState: React.FC<TransactionsErrorStateProps> = ({
  ...
  return (
    <div className="bg-[#1a1a1a] rounded-xl border border-[#505050] p-12 flex flex-col items-center justify-center">
  ...
  return (
    <div className="flex items-center justify-center mt-8 gap-4">
      <button
        ...
        className="bg-[#1a1a1a] border border-[#505050] text-white px-4 py-2 rounded-lg font-medium hover:bg-[#505050] transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#1a1a1a]"
      >
        Previous
      </button>
