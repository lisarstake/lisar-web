...
import { ChevronLeft, CircleQuestionMark, Pause, Play } from "lucide-react";
...
const learnContent: LearnContent[] = [
  {
    ...
    brief:
      "Learn what Lisar is and how it helps you earn extra income by securing blockchain networks with zero crypto knowledge required.",
    fullContent:
  ...
  },
  {
    ...
    videoUrl:
      "https://drive.google.com/file/d/1V9L49R6_2SjluIFFNEjwtGDeymCn70PL/view?usp=sharing",
    brief:
      "Start from the basics and learn what cryptocurrency is, how blockchains work, and why this matters for your Lisar experience.",
    fullContent:
...
export const LearnDetailPage: React.FC = () => {
  ...
  // Simulate video progress for highlighting
  React.useEffect(() => {
    if (isPlaying) {
      const interval = setInterval(() => {
        setCurrentHighlight((prev) => {
          if (prev < contentSentences.length - 1) {
            return prev + 1;
          } else {
            setIsPlaying(false);
            return 0;
  ...
  }, [isPlaying, contentSentences.length]);
  ...
  return (
    <div className="h-screen bg-[#050505] text-white flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-28 scrollbar-hide">
        {/* Video Player */}
        <div className="w-full h-64 bg-gray-600 rounded-xl mb-6 flex items-center justify-center relative">
          <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
            <button
              onClick={handlePlayPause}
              className="w-20 h-20 bg-[#C7EF6B] rounded-full flex items-center justify-center hover:bg-[#B8E55A] transition-colors"
            >
              {isPlaying ? (
      ...
      <HelpDrawer
        ...
        title="Video Guide"
        content={[
          "Watch videos and follow along with the highlighted script to learn about Lisar and crypto.",
          "Use play, pause, and reset controls to learn at your own pace.",
